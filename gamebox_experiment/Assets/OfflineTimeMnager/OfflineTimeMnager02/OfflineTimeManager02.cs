...
/// </summary>
public class OfflineTimeManager02 : MonoBehaviour
{
    public static OfflineTimeManager02 instance;
    ...
    public void CalculateOfflineEarnings()
    {
        ...
        ElapsedTimeInSeconds = (int)Math.Round(timeElasped.TotalSeconds, 0, MidpointRounding.ToEven); //経過時間
